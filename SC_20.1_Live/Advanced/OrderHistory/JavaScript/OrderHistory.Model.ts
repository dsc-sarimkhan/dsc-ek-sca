...
/// <amd-module name="OrderHistory.Model"/>
...
import OrderHistoryLineCollection = require('./OrderHistory.Line.Collection');
import ReturnAuthorizationCollection = require('../../ReturnAuthorization/JavaScript/ReturnAuthorization.Collection');

// @class OrderHistory.Model Model for showing information about past orders @extend Transaction.Model
const OrderHistoryModel: any = TransactionModel.extend({
    // @property {String} urlRoot
    urlRoot: Utils.getAbsoluteUrl('services/OrderHistory.Service.ss'),
    ...
    initialize: function(attributes) {
        ...
        this.on('change:returnauthorizations', function(model, returnauthorizations) {
            model.set(
                ...
                new ReturnAuthorizationCollection(returnauthorizations),
                { silent: true }
            );
        });
        this.trigger(
            'change:returnauthorizations',
            this,
            (attributes && attributes.returnauthorizations) || []
        );
