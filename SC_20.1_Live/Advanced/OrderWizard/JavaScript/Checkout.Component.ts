...
import SCConfiguration = require('../../SCA/JavaScript/SC.Configuration');
...
const CheckoutComponentGenerator: any = function CheckoutComponentGenerator(application) {
    ...
    const api_methods = {
        ...
        getCheckoutFlow: function getCheckoutFlow() {
            ...
            try {
                const checkoutStepsMap = _.invert(this.application.getConfig('checkoutStepsMap'));
                const checkoutStepsName = this.application.getConfig('checkoutStepsName');
...
export = CheckoutComponentGenerator;
