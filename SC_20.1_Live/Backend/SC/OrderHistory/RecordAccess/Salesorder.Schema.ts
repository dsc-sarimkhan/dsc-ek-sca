...
export class SalesorderSchema implements Schema {
    ...
    public readonly type = Type.SALES_ORDER;

    private static instance: SalesorderSchema;

    private constructor() {}

    public static getInstance(): SalesorderSchema {
        if (!this.instance) {
            this.instance = new SalesorderSchema();
        }
    ...
    public fields = {
        ...
        billcountry: new SchemaField<string>('billcountry'),
        billstate: new SchemaField<string>('billstate'),
        billcity: new SchemaField<string>('billcity'),
        billzip: new SchemaField<string>('billzip'),
        billaddr1: new SchemaField<string>('billaddr1'),
        billaddr2: new SchemaField<string>('billaddr2'),
        billattention: new SchemaField<string>('billattention'),
        billaddressee: new SchemaField<string>('billaddressee'),
        billphone: new SchemaField<string>('billphone'),
        ...
        shipcountry: new SchemaField<string>('shipcountry'),
        shipstate: new SchemaField<string>('shipstate'),
        shipcity: new SchemaField<string>('shipcity'),
        shipzip: new SchemaField<string>('shipzip'),
        shipaddr1: new SchemaField<string>('shipaddr1'),
        shipaddr2: new SchemaField<string>('shipaddr2'),
        shipattention: new SchemaField<string>('shipattention'),
        shipaddressee: new SchemaField<string>('shipaddressee'),
        shipphone: new SchemaField<string>('shipphone'),
    ...
    public filters = {
        ...
        statusRef: new SchemaColumn<string>('statusRef'),
    ...
    public columns = {
        ...
        quantityrevcommitted: new SchemaColumn<number>('quantityrevcommitted'),
        quantityshiprecv: new SchemaColumn<number>('quantityshiprecv'),
        quantityuom: new SchemaColumn<number>('quantityuom'),
        recognizedrevenue: new SchemaColumn<string>('recognizedrevenue'),
        recordtype: new SchemaColumn<string>('recordtype'),
        revcommitstatus: new SchemaColumn<string>('revcommitstatus'),
        revcommittingstatus: new SchemaColumn<boolean>('revcommittingstatus'),
    ...
    public initializeDefaults = {
        ...
        synctranlinesfromsubscription: 'synctranlinesfromsubscription',
