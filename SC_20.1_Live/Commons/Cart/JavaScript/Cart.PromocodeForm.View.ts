...
import ErrorManagement = require('../../ErrorManagement/JavaScript/ErrorManagement');
        ...
        if (!options.promocode) {
            ...
            this.model
                ...
                .fail(function savePromocodeFailed(jqXhr) {
                    self.state.errorMessage = ErrorManagement.parseErrorMessage(
                        jqXhr,
                        self.options.application.getLayout().errorMessageKeys
                    );
                })
