    ...
    return SCModel.extend({
        ...
        update: function update(data) {
            ...
            if (!this.isMultiShippingEnabled || !data.ismultishipto) {
                var isDataShipAddressDifferentToCurrentShipAddress =
                    data.shipaddress !== current_order.shipaddress;
        ...
        checkItemsAvailability: function checkItemsAvailability() {
            if (this.nonAvailableItems().length) {
                const message =
                    'Unfortunately this item/s is not longer available. Please <a href="' +
            ...
            for (i = 1; i <= placed_order.getLineItemCount('promotions'); i++) {
                if (
                    ...
                    result.promocodes.push({
                        ...
                        isvalid:
                            placed_order.getLineItemValue('promotions', 'promotionisvalid', i) ===
                            'T',
                        discountrate_formatted: ''
                    });
                }
        ...
        getSummary: function getSummary() {
            const { summary } = this.getFieldValues({
                keys: ['summary'],
                items: []
            });
