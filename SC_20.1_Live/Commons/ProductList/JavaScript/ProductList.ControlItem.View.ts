...
/// <amd-module name="ProductList.ControlItem.View"/>

import * as product_list_control_item_tpl from 'product_list_control_item.tpl';
...
export = BackboneView.extend({
    ...
    removeItemFromList: function(line) {
        const self = this;
        const selected_line = self.model.get('items').find(function(product_list_line) {
