...
/// <amd-module name="SC.ComponentContainer"/>
...
// @private
function sealComponent(component: any, component_name: any): any {
    try {
...
export = {
    ...
    // @public @extlayer
    // @return {Void}
    registerComponent: function registerComponent(component: any): void {
        if (component && component.componentName) {
            this._components[component.componentName] = sealComponent(
                component,
    ...
    getComponent: function getComponent(component_name: string): any {
