...
import ErrorManagementResponseErrorParser = require('../../../Commons/ErrorManagement/JavaScript/ErrorManagement.ResponseErrorParser');
        ...
        cart_promise.fail(function(error) {
            ...
            if (error) {
                if (error.responseJSON) {
                    ...
                    error_message = ErrorManagementResponseErrorParser(
                error,
