...
const SCCheckoutConfigurationStepsStandard: any[] = [
    {
        ...
        steps: [
            {
                ...
                continueButtonLabel: function () {
                    var continueBtnLabel = 'Continue to External Payment';

                    return this.wizard && this.wizard.isExternalCheckout()
                        ? Utils.translate(continueBtnLabel)
...
export = SCCheckoutConfigurationStepsStandard;
