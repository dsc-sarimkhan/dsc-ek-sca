...
import CartPromocodeListView = require('../../../Dynasoft/Cart/JavaScript/Cart.Promocode.List.View');
...
export = WizardModule.extend({
    ...
    getContext: function getContext() {
        ...
        return {
            ...
            showAfterPayButton: (window.location.hash.indexOf("billing")!==-1) && (this.liveOrderModel.get('afterpay_image')!=undefined) && (summary.total >= 1 && summary.total <= 2000) ? true : false,
