...
import * as Utils from '../../../Commons/../Commons/Utilities/JavaScript/Utils';

import * as jQuery from '../../../Commons/../Commons/Core/JavaScript/jQuery';

import BackboneFormView = require('../../../Commons/../Commons/Backbone.FormView/JavaScript/Backbone.FormView');
import GlobalViewsMessageView = require('../../../Commons/../Commons/GlobalViews/JavaScript/GlobalViews.Message.View');
import CartAddToCartButtonView = require('../../../Commons/../Commons/Cart/JavaScript/Cart.AddToCart.Button.View.js');
import ProductLineStockView = require('../../../Commons/../Commons/ProductLine/JavaScript/ProductLine.Stock.View');
import ProductViewsPriceView = require('../../../Commons/../Commons/ProductViews/JavaScript/ProductViews.Price.View');
import ProductLineSkuView = require('../../../Commons/../Commons/ProductLine/JavaScript/ProductLine.Sku.View');
...
import ProductLineStockDescriptionView = require('../../../Commons/../Commons/ProductLine/JavaScript/ProductLine.StockDescription.View');
...
import ProductDetailsShortDescriptionView = require('../JavaScript/ProductDetails.ShortDescription.View');
import ProductDetailsPaymentMethods = require('../JavaScript/ProductDetails.PaymentMethods.View');
...
const ProductDetailsBaseView: any = BackboneView.extend({
            ...
            item.fetch({
                ...
                function (data, _result, jqXhr) {
                    if (!item.isNew()) {
                        ...
                        promise.reject();
                    } else if (jqXhr.responseJSON && jqXhr.responseJSON.errorCode !== 'ERR_USER_SESSION_TIMED_OUT') {
        ...
        updateURL: function updateURL() {
            Backbone.history.navigate(this.model.generateURL(), {
                replace: true
            });
        },
        ...
        childViews: {
            ...
            'Product.ShortDescription': function () {
                return new ProductDetailsShortDescriptionView({
                    model: this.model
                });
            },

            'Product.PaymentMethods': function () {
                return new ProductDetailsPaymentMethods({
                    model: this.model
                })
            },
        ...
        getContext: function () {
            ...
            return {
                ...
                model: this.model,
                  //@property {String} afterpayInstallment
                  afterpayInstallment: (this.model.getPrice().price/4).toFixed(2) || '',
