...
const StoreLocatorDetailsView: any = BackboneView.extend({
    ...
    beforeShowContent: function beforeShowContent() {
        ...
        var storeType = DscUtils.getURLParam('type');
    ...
    getContext: function getContext() {
        var storeType = (DscUtils.getURLParam('type')) ? '&type='+DscUtils.getURLParam('type') : '';
        ...
        return {
            ...
            redirectUrl: last_navigation ? 'stores'+storeType : 'stores/all'
        };
    }
});
