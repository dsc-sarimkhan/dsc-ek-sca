...
const StoreLocatorMainView: any = BackboneView.extend({
    ...
    getContext: function getContext() {
        var cstmTitle = (DSCUtils.getURLParam('type') == '1') ? "Find a Dealer" : 'Find a Service Agent';
        // @class StoreLocator.Main.View.Context
        return {
            // @property {String} title
            title: cstmTitle || this.reference_map.configuration.title(),
            service_msg : cstmTitle == 'Find a Service Agent' ? true : false,
