...
gulp.task('ssp-files', function (cb)
{
	...
	return gulp.src(ssp_files, {allowEmpty: true})
...
function buildTemplateContextFor(file)
{
	...
	{
		context.applicationStarter = starterTemplate({starterName: appStarterMap[file.relative], is_shopping: appStarterMap[file.relative] === shoppingStarter});
	}
