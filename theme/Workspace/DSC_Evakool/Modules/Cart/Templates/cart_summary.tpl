	...
	<div class="cart-summary-container">
		...
		{{#if isPriceEnabled}}
			...
			{{#if showPickupInStoreLabel}}
				...
				{{/if}}
	<!--Author::Humza:- Edit this chunk to show GST on Order Summary Before Checkout -->
	{{#if areAllItemsPickupable}}
			{{#if suiteTaxesEnabled}}
			{{#each suiteTaxes}}
				...
				<div class="cart-summary-pickup-container">
					<p class="cart-summary-grid-float">
						...
						<span class="cart-summary-pickup-label-free">{{taxTotal}}</span>
					</p>
				</div>
			{{/each}}
		{{else if model.summary.taxtotal}}
			<!-- <p class="order-wizard-cart-summary-grid-float">
				<span class="order-wizard-cart-summary-tax">
			...
			<div class="cart-summary-pickup-container">
				<p class="cart-summary-grid-float">
					{{translate taxLabel}}
					<span class="cart-summary-pickup-label-free">{{model.summary.taxtotal_formatted}}</span>
				</p>
			</div>
		{{/if}}
		...
		{{#if model.summary.tax2total}}
			...
			<div class="cart-summary-pickup-container">
				<p class="cart-summary-grid-float">
					{{translate 'PST'}}
					<span class="cart-summary-pickup-label-free">{{model.summary.tax2total_formatted}}</span>
				</p>
			</div>
		{{/if}}
		...
		<div class="cart-summary-total">
			...
			{{#if showAfterpayText}}
			<afterpay-placement style="padding-left:15px;" data-locale="en_AU" data-currency="AUD" data-amount={{summary.total}}></afterpay-placement>
			{{/if}}
		</div>
		{{/if}}
<!--Author::Humza:- chunk End -->
	...
	{{#if showPromocodeForm}}
		<div class="cart-summary-grid cart-summary-promocode-container">
			...
			<div class="cart-summary-expander-body collapse in" role="form" id="promo-code-container" aria-expanded="true">
	...
	{{#if showActions}}
		<div class="cart-summary-button-container">
			{{#unless upsell}}
			<a id="btn-proceed-checkout" class="cart-summary-button-proceed-checkout " href="{{origin}}/cart?upsell=true" >
				{{translate 'Continue'}}
			</a>
			{{/unless}}
			{{#if upsell}}
			<a id="btn-proceed-checkout" class="cart-summary-button-proceed-checkout {{#if showProceedButton}} cart-summary-button-proceed-checkout-sb {{/if}}" href="#" data-touchpoint="checkout" data-hashtag="#" {{#ifEquals selectedFulfillmentChoice false}} style="opacity:0.5" disabled{{/ifEquals}}>
