<div id="layout" class="checkout-layout">
	<header id="site-header" class="checkout-layout-header dsc-checkout-layout-header" data-view="Header"></header>
	<!-- <div class="dsc-banner-text">CHILLED FOR GOOD TIMES</div> -->
