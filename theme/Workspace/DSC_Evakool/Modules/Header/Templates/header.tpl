...
<div class="header-main-wrapper {{#if isStandalone}}header-main-wrapper-standalone{{/if}} dsc-header">
	{{#unless isStandalone}}
	<div class="header-subheader dsc-header-subheader">
		<div class="header-subheader-container">
			<div class="header-logo-wrapper dsc-header-top-logo">
			...
			<ul class="header-subheader-options dsc-header-subheader-options">
				...
				<li>
					<a href="#/stores?type=1" class="storelocator-accesspoints-headerlink-link" data-touchpoint="home"
						data-hashtag="/stores?type=1"><i
							class="storelocator-accesspoints-headerlink-link-icon"></i><span
							class="storelocator-accesspoints-headerlink-link-text">Find a Dealer</span></a></li>
	...
	<nav class="header-main-nav">
		...
		<div class="header-content">
			...
			<div class="header-logo-wrapper dsc-header-mid-logo">
				<div data-view="Header.Logo"></div>
			</div>
