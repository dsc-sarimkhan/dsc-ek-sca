		...
		<div class="order-wizard-cartitems-module-pickup-in-store-package-accordion-container" data-content="order-items-body">
			{{#if showLocation}}
				<div class="order-wizard-cartitems-module-pickup-in-store-package-dropdown">
					<a id="order-wizard-cartitems-module-pickup-in-store-package-view-location-dropdown" class="order-wizard-cartitems-module-pickup-in-store-package-view-location-data-link dsc-pickup-in-store-package-view-location-data-link" data-toggle="dropdown" aria-expanded="true">
