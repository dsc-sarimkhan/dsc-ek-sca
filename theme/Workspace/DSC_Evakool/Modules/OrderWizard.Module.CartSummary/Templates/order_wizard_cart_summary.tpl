	...
	<div class="order-wizard-cart-summary-body">
			...
			<p class="order-wizard-cart-summary-grid-float">
				...
				<span class="order-wizard-cart-summary-subtotal-label">
					...
					<p class="order-wizard-cart-summary-subtotal-legend">
						{{translate 'Subtotal does not include shipping or tax'}}</p>
				</span>
			</p>
		</div>
		...
		<div class="order-wizard-cart-summary-giftcertificate-applied">
			<p class="order-wizard-cart-summary-gift-certificate">
				{{translate 'Gift Certificates Applied ($(0))' giftCertificates.length}}</p>
		...
		<div class="order-wizard-cart-summary-total">
			...
			{{#if showAfterpayText}}
			<afterpay-placement style="padding-left:15px;" data-locale="en_AU" data-currency="AUD" data-amount="{{model.summary.total}}"></afterpay-placement>
			{{/if}}
		</div>
...
{{#if showAfterPayButton}}
<br>
<button class="dsc-payment-image" data-action="afterpay-continue">
	<img src="{{imageURLAfterPayButton}}" height="90" width="90">
</button>
{{/if}}

{{#if showZipPayButton}}
<br>
<button class="dsc-payment-image" data-action="zippay-continue">
	<img src="{{imageURLZipPayButton}}" height="90" width="90">
</button>
{{/if}}
