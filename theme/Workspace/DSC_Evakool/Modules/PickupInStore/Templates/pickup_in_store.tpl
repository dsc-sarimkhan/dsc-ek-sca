...
<div class="pickup-in-store">
	{{#if isAvailable}}
		...
		{{#unless isAvailableForPickupOnly }} <!-- only available for pickup -->
			<div class="pickup-in-store-option col-md-6 col-xs-12">
				...
				{{else}}
					<div class="pickup-in-store-option-column hide" data-action="selectShip">
						<input
							type="radio"
				...
				<div class="pickup-in-store-option-column">
					{{#unless isAvailableForShipOnly }}
						<label for="pickup-in-store-option-ship-{{itemInternalId}}" class="hide"> {{translate 'Ship'}}</label>
					{{/unless}}

					<div>
						{{#if stockInfo.isInStock }}
							<p class="instock-message product-line-stock-msg-out">
								<span class="product-line-stock-icon-out"><i></i></span>
								<span class="pickup-in-store-option-ship-status pickup-in-store-option-status-not-available">In Stock</span>
							</p>
							<div class="hide">
						...
						{{#if stockInfo.showOutOfStockMessage}}
							{{#unless hideOOSMessage}}
							<p class="stock-message product-line-stock-msg-out">
								<span class="product-line-stock-icon-out"><i></i></span>
		...
		{{#unless isAvailableForShipOnly}}
			<div class="pickup-in-store-option col-md-6 col-xs-12 hide">
