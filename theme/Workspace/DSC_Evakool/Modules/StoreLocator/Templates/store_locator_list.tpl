<li class="store-locator-list-box" data-id={{storeId}}>
	<a href="stores/details/{{storeId}}{{#if storeType}}?type={{storeType}}{{/if}}" data-toggle="show-in-pusher">
		<div class="store-locator-list-box-count">
			<div>{{index}}</div>
		</div>
		<ul class="store-locator-list-box-info">
			<li>
				<strong class="store-locator-list-box-info-name" title="{{storeName}}">{{storeName}}</strong>
			</li>
