<li class="store-locator-tooltip-box">
	<a href="stores/details/{{storeId}}{{#if storeType}}?type={{storeType}}{{/if}}">
		...
		<a href="stores/details/{{storeId}}{{#if storeType}}?type={{storeType}}{{/if}}" class="store-locator-tooltip-box-arrow-container">
